...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.camacho-y-asociados-abogados.com/fotologotipodecamacho.jpeg" },
      ...
      { name: "twitter:image", content: "https://www.camacho-y-asociados-abogados.com/fotologotipodecamacho.jpeg" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "canonical", href: "https://www.camacho-y-asociados-abogados.com/" },
